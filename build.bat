...
FC_Menu_List_Tool.exe -in text/text_title.txt -asm tmp/title_output -list tmp/title_output.txt -line 16 -return 8 -begin 0 -name Title_Text_ -bank_count 1 -index_enable 0 -total 16
