...
FC_Menu_List_Tool.exe -in text/text_title.txt -asm tmp/title_output -list tmp/title_output.txt -line 16 -return 8 -begin 0 -name Title_Text_ -bank_count 1 -index_enable 0 -total 32 -line_count 1
FC_Font_Tool_Title.exe -in tmp/title_output.txt -out tmp/chr_title.chr -ini Config/FC_Font_Tool_Title.ini
FC_Menu_List_Tool.exe -in build/game_list.txt -asm tmp/list_output -list tmp/list_output.txt -line 16 -return 8 -begin 0 -name Item_Text_ -info tmp/list_info.asm -bank_count 8 -index_enable 1
