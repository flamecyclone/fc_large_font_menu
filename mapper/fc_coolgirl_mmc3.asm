...
;=================================================
MAPPER_CODE                 =   %00010100
PRG_BANKING_MODE            =   %00000100
CHR_BANKING_MODE            =   %00000010
FLAG_CODE                   =   %00000000
;=================================================
...
.Rom_Chr_Bank_Init_0000_0FFF
;初始化 CHR Bank $0000-07FF
    LDX #$00
    LDY #$00
    STX MAPPER_CTRL
    STY MAPPER_DATA
...
;初始化 CHR Bank $1000-1FFF
.Rom_Chr_Bank_Init_1000_1FFF
    INX
    INY
    STX MAPPER_CTRL
    STY MAPPER_DATA
    CPX #MAPPER_CHR_INDEX_COUNT - 1
